...
using ShoppingCart.Services.CouponAPI.Models.Dto;
using ShoppingCart.Services.CouponAPI.Models;
using ShoppingCart.Services.CouponAPI.Data;

namespace ShoppingCart.Services.CouponAPI.Controllers
{
    [Route("api/coupon")]
    [ApiController]
    [Authorize]
